            ...
            foreach ($message->getFrom() as $from_email=>$from_name) {
                ...
                try {
                    $tracker = SentEmail::create([
                        ...
                        'subject'=>$subject,
                        'content'=> config('mail-tracker.log-content', true) ? self::removeEmoji(strlen($original_content) > 65535 ? substr($original_content, 0, 65534) . "…" : $original_content) : null,
                        'opens'=>0,
                        'clicks'=>0,
